 ...
 * @see com.privatecloud.users.model.generated.UserRoles
...
public class UserRolesHome {
	...
	public UserRoles findById(java.lang.Integer id) {
		...
		try {
			UserRoles instance = (UserRoles) sessionFactory
					.getCurrentSession()
					.get("com.privatecloud.users.model.generated.UserRoles", id);
			if (instance == null) {
	...
	public List<UserRoles> findByExample(UserRoles instance) {
		...
		try {
			List<UserRoles> results = (List<UserRoles>) sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.privatecloud.users.model.generated.UserRoles")
